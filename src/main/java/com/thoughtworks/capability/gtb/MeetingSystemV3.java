...
public class MeetingSystemV3 {
    ...
    public static void main(String[] args) {
        ...
        ZonedDateTime zonedLondonTime = ZonedDateTime.of(meetingTime, LONDON_ZONE);
        ...
        if (now.isAfter(meetingTime)) {
            ...
            ZonedDateTime zonedDateTime = ZonedDateTime.of(meetingTime, ZoneId.systemDefault());

            // 格式化新会议时间
            String showTimeStr = formatter.format(zonedDateTime.withZoneSameInstant(CHICAGO_ZONE).toLocalDateTime());
